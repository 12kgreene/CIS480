  ...
  <div id="main">
    <div id="header">
	  ...
	  <input type="text" name="user" class="form-control" placeholder="Username">
        ...
        </br><button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Login</button> | 
        <a class="btn btn-lg btn-primary btn-block" href="register.php">Register</a>
      </form></br><a href="logout.php">Logout</a></br>
<div id="error" style=" <?php  if($error !=""){ ?>  display:block; <?php } ?> "><?php echo $error; ?></div>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="examples.html">MenuContent1</a></li>
          <li><a href="page.html">Menu Content 2</a></li>
          <li><a href="another_page.html">Menu Content 3</a></li>
