...
<div id="error" style=" <?php  if($error !=""){ ?>  display:block; <?php } ?> "><?php echo $error; ?></div>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected><a href="indexInstructor.php">Home</a></li>
          <li><a href="projectInstructor.html">Current Projects</a></li>
          <li ><a href="aboutInstructor.html">Help/About</a></li>
		  <li><a href="fileUploadFormInstructor.php">Upload Files</a></li>
